...
import cv2
import numpy as np
from tkinter import Scale, Button, Label, Tk ,Checkbutton
...
class ImageProcessingApp:
    ...
    def add_slider(self,from_, to_, default, command):
        ...
        slider = Scale(self.master, from_=from_, to=to_, orient=tk.HORIZONTAL,fg="white",bg="brown",activebackground="yellow",borderwidth=2,cursor="sb_h_double_arrow")
        slider.set(default)
